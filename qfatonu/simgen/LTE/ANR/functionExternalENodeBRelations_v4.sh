...
# Ver 4       : functionExternalENodeBRelations_v4.sh
# Purpose     : to fix crontab error PWD variable change to /netsim which default HOME variable of crontab
# Description : This script should be located and run in /netsim directory
# Date        : 15 Nov 2010
# Who         : Fatih ONUR
