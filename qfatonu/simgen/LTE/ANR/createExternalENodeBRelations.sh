...
Usagei : $0 <LTE SIM NO> (ex: for LTEA70-ST-LTE24.zip is 24)
 
Example: $0 24 

Config: Configurable parameters within script under 'Assign variables' title are followings...

ERBSID_START - First ERBSID to be connect with ExternalNodeBFunction
...
DELETE - DELETE equals YES means to delete created ExternalNodeBFunction and Relations instaed of creating
...
# DELETE equals YES means to delete created ExternalNodeBFunction and Relations instaed of creating
DELETE=NO
