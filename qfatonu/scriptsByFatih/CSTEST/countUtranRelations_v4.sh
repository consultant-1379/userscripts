...
do
  ...
  UTRANCELLS=`grep $RNCNAME UtranCellsSorted.txt`
  ...
  do
     ...
     #UTRAN_RELATIONS_PER_CELL=`cstest lm $UTRANCELL -f '$type_name==UtranRelation' | sed -n 32,60p `
     #echo "UTRAN_RELATIONS_PER_CELL="$UTRAN_RELATIONS_PER_CELL
     #exit

     #UTRAN_RELATIONS_PER_CELL=`grep $UTRANCELL UtranRelations.txt`
     UTRAN_RELATIONS_PER_CELL=`grep $UTRANCELL UtranRelations_RNC01.txt`
     #
     #echo "UTRAN_RELATIONS_PER_CELL="$UTRAN_RELATIONS_PER_CELL
     #exit
