...
while ($count_For_Rnc <= $end)
{
  ...
  print "-----------------------------------------\n";
     ...
     if ($total_Num_Of_Intra_Relation_Per_Rnc != $requiredNumber){
       push(@resultArray, "$rncName");
       push(@resultArray, "Intra");
       push(@resultArray, $requiredNumber);
       push(@resultArray, $total_Num_Of_Intra_Relation_Per_Rnc);
     }
     ...
     if ($total_Num_Of_Inter_Relation_Per_Rnc != $requiredNumber){
       push(@resultArray, "$rncName");
       push(@resultArray, "Inter");
       push(@resultArray, $requiredNumber);
       push(@resultArray, $total_Num_Of_Inter_Relation_Per_Rnc);
     }
     ...
     if ($total_Num_Of_External_Relation_Per_Rnc != $requiredNumber){
       push(@resultArray, "$rncName");
       push(@resultArray, "External");
       push(@resultArray, $requiredNumber);
       push(@resultArray, $total_Num_Of_External_Relation_Per_Rnc);
     }
...
foreach my $value (@resultArray){
   ...
   if ($arrayCount == 0 || ($arrayCount % 4 == 0)){
     $rncName = $resultArray[$arrayCount];
     print "-----------------------------------------\n";
     print "\Utype=$rncName ";
   }
   elsif ($arrayCount == 1 || ($arrayCount % 4 == 1)){
     $type = $resultArray[$arrayCount];
     print "\Utype=$type ";
   }
   elsif ($arrayCount == 2 || ($arrayCount % 4 == 2)){
     $requiredNumber= $resultArray[$arrayCount];
     print "\Urequired_Num_Of_Relation=$requiredNumber ";
   }
   elsif ($arrayCount == 2 || ($arrayCount % 4 == 3)){
     $realNumber= $resultArray[$arrayCount];
     print "\Ureal_Num_of_Relation=$realNumber\n";
     print "-----------------------------------------\n";
   }
